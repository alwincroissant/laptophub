...
<head>
    ...
    <title>LaptopHub — Edit Product</title>
...
<div class="main">
    <div class="topbar">
        <div>
            <h1>Edit Product</h1>
            <p class="sub">Update product details in catalog.</p>
        </div>
    ...
    <div class="content">
        ...
        <div class="form-card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.product.update', $product) }}" class="row g-3">
                    @csrf
                    @method('PUT')
