            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.product.update', $product) }}" class="row g-3" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $product->name) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="price" name="price" type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $product->price) }}">
                        @error('price')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="col-md-4">
                        <label class="form-label" for="stock_qty">Stock Quantity</label>
                        <input id="stock_qty" name="stock_qty" type="number" class="form-control @error('stock_qty') is-invalid @enderror" value="{{ old('stock_qty', $product->stock_qty) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="low_stock_threshold" name="low_stock_threshold" type="number" class="form-control @error('low_stock_threshold') is-invalid @enderror" value="{{ old('low_stock_threshold', $product->low_stock_threshold) }}">
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="compatibility" name="compatibility" class="form-control @error('compatibility') is-invalid @enderror" rows="2">{{ old('compatibility', $product->compatibility) }}</textarea>
