    ...
    @endif
        ...
        <div class="table-card mt-3">
            ...
            <div class="table-responsive">
                {!! $dataTable->table(['class' => 'table table-hover mb-0 align-middle w-100', 'id' => 'brandsTable']) !!}
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            setTimeout(function() {
                ...
                var table = window.LaravelDataTables["brandsTable"];
                table.buttons().container().appendTo('#table-buttons');

                statusFilter.on('change', function() {
                    window.location.href = "{{ route('admin.brand.index') }}?status=" + $(this).val();
                });
            }, 300);
        });
    </script>
